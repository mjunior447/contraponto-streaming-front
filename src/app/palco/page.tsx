...
export default async function PalcoPage() {
    ...
    // Filtra os vídeos que pertencem à categoria 'palco'
    const videos = allVideos.filter(v => v.category === 'palco');
        ...
        <main className="max-w-7xl mx-auto px-6 py-10 w-full">
            <header className="mb-10">
                ...
                <p className="text-brand-muted text-sm md:text-base max-w-2xl">
                    Explore registros de artes cênicas, espetáculos teatrais, performances e manifestações artísticas gravadas em alta qualidade.
                </p>
            </header>
